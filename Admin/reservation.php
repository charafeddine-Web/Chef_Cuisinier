                                ...
                                <div
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="bg-white">
                                            <?php
                                            $sql = "SELECT R.ReservationID, R.ReservationDate, R.NumberOfPeople, R.Status, u.full_Name AS client, M.Title AS Menu 
            FROM Reservations R
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            <?php if ($reservation['Status'] !== 'Approved') { ?>
                                                                <a href="approve_reservation.php?id=<?php echo $reservation['ReservationID']; ?>"
                                                            ...
                                                            <?php if ($reservation['Status'] !== 'Rejected') { ?>
                                                                <a href="reject_reservation.php?id=<?php echo $reservation['ReservationID']; ?>"
                                                                    class="text-red-600 hover:text-red-900 pl-2">Reject</a>
                                                            <?php } else { ?>
