                                ...
                                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                            <?php
                                            $roleid = 3;
                                            $sql = "SELECT count(*) as total_client FROM users where RoleID= ?";
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                echo "<h4 class='text-2xl font-semibold text-gray-700'>" . $data['total_client'] . "</h4>";
                                            } else {
                                                echo "<h4 class='text-2xl font-semibold text-gray-700'>0</h4>";
                                            }
                                            ?>
                                            <div class="text-gray-500">New Client</div>
                                        </div>
                                ...
                                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            ?>
                                            <div class="text-gray-500">Total Menu</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            if ($result->num_rows > 0) {
                                                $data = $result->fetch_assoc();
                                                echo "<h4 class='text-2xl font-semibold text-gray-700'>" . $data['total_reservation'] . "</h4>";
                                            } else {
                                                echo "<h4 class='text-2xl font-semibold text-gray-700'>0</h4>";
                                            }
                                            ?>
                                            <div class="text-gray-500"> Reservation</div>
                                        </div>
                                    </div>
                                </div>
